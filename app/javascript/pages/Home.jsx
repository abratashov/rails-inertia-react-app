    ...
    <>
      ...
      <div className="my-3">
        ...
        <ul className="m-4 list-disc">
          <li><pre className="inline bg-slate-100">app/frontend/pages/Home.jsx</pre>: The React component containing what you're reading now!</li>
          <li><pre className="inline bg-slate-100">app/controllers/home_controller.rb</pre>: The controller that handled rendering this page</li>
